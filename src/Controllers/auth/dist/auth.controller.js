...
var local_strategy_1 = require("src/Models/Guards/local.strategy");
var response_1 = require("src/Models/Interface/response");
var passport_1 = require("@nestjs/passport");
var AuthController = /** @class */ (function () {
    function AuthController(_authService, _userService) {
        this._authService = _authService;
        this._userService = _userService;
    }
    AuthController.prototype.login = function (req, response) {
        return __awaiter(this, void 0, Promise, function () {
            var _apiResponse;
            return __generator(this, function (_a) {
                _apiResponse = new response_1.ApiResponse();
                return [2 /*return*/, this._authService.signIn(req.user).then(function (data) {
    ...
    __decorate([
        common_1.Post('/login'),
        common_1.UseGuards(local_strategy_1.LocalAuthGuard),
