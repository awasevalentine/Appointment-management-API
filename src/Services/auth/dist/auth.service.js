...
var AuthService = /** @class */ (function () {
    function AuthService(_userService, jwtService) {
    ...
    AuthService.prototype.validateUser = function (email, pass) {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._userService.getUserById(email)];
                    case 1:
                        user = _a.sent();
                        if (!user) {
                            throw new common_1.NotFoundException();
                        }
                        return [4 /*yield*/, bcrypt.compare(pass, user.password).then(function (validUser) {
                                if (validUser) {
